...
public class SimplePeer extends Peer {
	...
	private MainActivity peerActivity=null;
	...
	protected void onReceivedJSONMsg(JsonObject jsonMsg, Address sender) {
		...
		final String msg = jsonMsg.toString(); 
		...
		try {
			...
			{*/
				MainActivity.handler.post(new Runnable() {
	                  public void run() {
	             		 	Toast toast = Toast.makeText(peerActivity.getBaseContext(),"Received: "+ msg ,Toast.LENGTH_LONG);
	             		 	toast.show();
	                      }
	              });
	...
	public void setPeerActivity(MainActivity peerActivity) {
